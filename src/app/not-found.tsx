...
const notFoundMessage = notFoundMessages[Math.floor(Math.random() * notFoundMessages.length)]
...
export default function NotFound() {
  const emojiSrc = extractImageSrc(notFoundMessage.emoji)
  ...
  return (
    <Section>
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <p className="text-xl text-gray-700 dark:text-gray-300 mb-2">{notFoundMessage.text}</p>
