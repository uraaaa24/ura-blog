    ...
    <Link href={href} {...externalProps} className="border-b border-gray-300 py-4 block">
      <article className="h-full">
        <div className="flex items-center gap-2">
          <div className="w-20 h-20 mr-4 bg-gray-200 rounded-xl flex-shrink-0 flex items-center justify-center overflow-hidden">
            <Image src={post.thumbnail ?? ''} alt={post.title} width={50} height={50} unoptimized />
          </div>
